        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Customdatafield(label: 'Deskripsi', value: 'Dompet Adidas berwarna hitam dan isinya terdapat kartu atm ktp sim', icon: Icons.description, fontsize: 16.0),
              Customdatafield(label: 'Jenis Laporan', value: 'Ditemukan', icon: Icons.description, fontsize: 16.0),
              Customdatafield(label: 'Lokasi Kejadian', value: 'CM202', icon: Icons.description, fontsize: 16.0),
